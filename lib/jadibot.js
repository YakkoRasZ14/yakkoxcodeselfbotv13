...
const jadibot = async(reply,keysa,id,yok) => {
...
bot = await keysa.sendMessage(id,buffer,MessageType.image,{quoted : yok,caption:'Scan QR Untuk menjadi BOT Sementara!\n\n1.Klik titik tiga pojok kanan atas\n2.Ketuk Whatsapp Web\n3.Scan QR ini\n\nNote : QR Expired dalam 20detik!'})
setTimeout(() => {
keysa.deleteMessage(id, bot.key)
},30000)
})
conn.on('connecting', () => {
})
